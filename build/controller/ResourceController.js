...
exports.getAll = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, page, limit, pageNum, limitNum, resourceRepo, resources;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                resourceRepo = typeorm_1.getRepository(Resource_1.Resource);
                return [4 /*yield*/, resourceRepo.find({
                        take: limitNum,
...
exports.getOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                resourceRepo = typeorm_1.getRepository(Resource_1.Resource);
                return [4 /*yield*/, resourceRepo.findOne(req.params.id)];
            case 1:
                resource = _a.sent();
                return [2 /*return*/, res.status(200).json(resource)];
        }
    });
}); };
