...
router.get("/shoutouts", isAuthenticated_1.isAuthenticated, ShoutoutController_1.getAll);
router.get("/shoutouts/:id", isAuthenticated_1.isAuthenticated, ShoutoutController_1.getOne);
router.post("/shoutouts", isAuthenticated_1.isAuthenticated, ShoutoutController_1.create);
